...
def plot_training(result):
    ...
    file_figobj = 'Output/FigureObject/result_plot.fig.pickle' 
    file_pdf = 'Output/Figures/result_plot_att.pdf' 
...
def plot_confusion_matrix(cm, classes, normalize=False, title='Confusion matrix', cmap=plt.cm.Blues):
    ...
    pickle.dump(fig_conf, open(file_pdf, 'wb'))
...
def plot_segmentation_test(xval,yval, ypred, num_samples):
    ...
    file_pdf = 'Output/Figures/segmentationattvrai.pdf' % ()
    pickle.dump(fig, open(file_figobj, 'wb'))
    fig.savefig(file_pdf, bbox_inches='tight')
